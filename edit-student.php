...
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" value="<?php echo htmlentities($result->RollId)?>"  required="required" autocomplete="off">
</div>
</div>
...
<?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
<input type="text" name="classname" class="form-control" id="classname" value="<?php echo htmlentities($result->ClassName)?>(<?php echo htmlentities($result->ClassNameNumeric)?>-<?php echo htmlentities($result->Section)?>)" readonly>
                                                        </div>
                                                    </div>
<div class="form-group">
...
<div class="col-sm-10">
<input type="number" name="batch" class="form-control" id="batch" value="<?php echo htmlentities($result->passedoutyear)?>" required="required" autocomplete="off">
</div>
</div>
<?php }} ?>
