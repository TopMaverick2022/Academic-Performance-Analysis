...
<div class="left-sidebar bg-black-300 box-shadow ">
  ...
  <li class="has-children">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-user"></i> <span>Faculty</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="create-faculty.php"><i class="fa fa-bars"></i> <span>Create Faculties</span></a></li>
                                            <li><a href="manage-faculty.php"><i class="fa fa fa-server"></i> <span>Manage Faculties</span></a></li>
                                           <li><a href="add-facultycombination.php"><i class="fa fa-newspaper-o"></i> <span>Add Faculty Combination</span></a></li>
                                           <a href="manage-facultycombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Faculty Combination </span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
...
<li class="has-children">
                                        ...
                                        <li><a href="departmentdata.php"><i class="fa fa fa-server"></i> <span> Other Logins</span></a></li>
