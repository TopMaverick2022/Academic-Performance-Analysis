...
<?php
$sql1 ="SELECT DISTINCT s.StudentName
FROM studentdata s
JOIN classdata c ON c.id = s.ClassId
WHERE c.ClassName ='$departmentname';";
...
<?php
$sql ="SELECT DISTINCT scd.subjectid
FROM subjectcombinationdata scd
JOIN classdata c ON c.id = scd.classid
WHERE c.ClassName = '$departmentname';";
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        ...
                                        <?php
$sql3="SELECT 
COUNT(rd.grades) AS total_grades,
COUNT(CASE WHEN rd.grades > 0 THEN 1 ELSE NULL END) AS total_grades_greater_than_zero,
(COUNT(CASE WHEN rd.grades > 0 THEN 1 ELSE NULL END) * 100.0) / NULLIF(COUNT(rd.grades), 0) AS percentage_grades_greater_than_zero
FROM 
resultdata rd
JOIN 
classdata cd ON rd.classid = cd.id
WHERE 
cd.ClassName ='$departmentname';";
