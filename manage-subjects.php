...
<td>
<a  class="btn btn-primary"href="edit-subject.php?subjectid=<?php echo htmlentities($result->id);?>">Edit</a> 
<a  class="btn btn-danger"href="delete-subjects.php?subjectid=<?php echo htmlentities($result->id);?>">Delete</a> 
