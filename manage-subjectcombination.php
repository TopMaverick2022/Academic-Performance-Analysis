...
$status=1;
$sql="update subjectcombinationdata set status=:status where id=:acid ";
...
$did=intval($_GET['did']);
$status=0;
$sql="update subjectcombinationdata set status=:status where id=:did ";
$query = $dbh->prepare($sql);
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT classdata.ClassName,classdata.ClassNameNumeric,classdata.Section,subjectdata.SubjectName,subjectcombinationdata.id as scid,subjectcombinationdata.status from subjectcombinationdata join classdata on classdata.id=subjectcombinationdata.ClassId  join subjectdata on subjectdata.id=subjectcombinationdata.SubjectId";
$query = $dbh->prepare($sql);
$query->execute();
